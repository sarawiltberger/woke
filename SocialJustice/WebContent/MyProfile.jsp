...
<% }else {  //if the user is a real user
	...
	%> <span id="getuser" style="visibility: hidden"><%= user.getID()+""%></span><% 
	url = user.getPicURL();
...
<div class="container">
	<div class="row profile-container">
		...
		<div class="col-md-8 user-post-container">
			<!-- sample posts -->
			<!-- NEED TO FILL WITH loop to get this users posts -->
...
<script src="postsClientUser.js"></script>
</body>
</html>
